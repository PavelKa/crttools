from ctypes import *
lib = cdll.LoadLibrary("./build/crttoolsw.dll")
...
for i in range(0, textCount):
    keysArray.append(GoString ("key"+`i`,100)  )
    valuesArray.append(GoString ("value"+`i`,100))

keys = GoSlice((c_void_p * textCount) ("","","","","","","","",""), textCount, textCount)
values = GoSlice((c_void_p * textCount) ("","","","","","","","",""), textCount, textCount)




lib.GetPSD2CertMap.argtypes = [GoString,GoSlice,GoSlice]
lib.GetPSD2CertMap.restype = c_int


res = lib.GetPSD2CertMap(msg,keys,values)
